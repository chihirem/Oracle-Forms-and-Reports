...
<report name="r6formwizard" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="R6FORMWIZARD" xmlPrologType="text">
...
FROM EMP_DETAILS_VIEW ]]>
      ...
      <group name="G_FIRST_NAME">
        ...
        <dataItem name="STATE_PROVINCE" datatype="vchar2" columnOrder="14"
         width="25" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="State Province">
        ...
        <dataItem name="COUNTRY_NAME" datatype="vchar2" columnOrder="15"
         ...
         columnFlags="33" defaultLabel="Country Name">
        ...
        <dataItem name="REGION_NAME" datatype="vchar2" columnOrder="16"
         width="25" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Region Name">
       ...
       columnMode="no">
        ...
        <field name="F_FIRST_NAME" source="FIRST_NAME" minWidowLines="1"
         spacing="0" alignment="start">
          ...
          <geometryInfo x="0.75000" y="0.00000" width="1.50000"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        <field name="F_STATE_PROVINCE" source="STATE_PROVINCE"
         minWidowLines="1" spacing="0" alignment="start">
          <font face="helvetica" size="10"/>
          <geometryInfo x="1.00000" y="0.18750" width="1.50000"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        <text name="B_STATE_PROVINCE" minWidowLines="1">
        ...
        <field name="F_COUNTRY_NAME" source="COUNTRY_NAME" minWidowLines="1"
         spacing="0" alignment="start">
          <font face="helvetica" size="10"/>
          <geometryInfo x="3.50000" y="0.18750" width="1.50000"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        <text name="B_COUNTRY_NAME" minWidowLines="1">
          <textSettings spacing="0"/>
          <geometryInfo x="2.50000" y="0.18750" width="1.00000"
           height="0.18750"/>
          <visualSettings fillBackgroundColor="r25g50b75"/>
          <textSegment>
            <font face="helvetica" size="10" bold="yes"/>
        ...
        <text name="B_LAST_NAME" minWidowLines="1">
          <textSettings spacing="0"/>
          <geometryInfo x="2.25000" y="0.00000" width="0.75000"
           height="0.18750"/>
          <visualSettings fillBackgroundColor="r25g50b75"/>
          <textSegment>
            <font face="helvetica" size="10" bold="yes"/>
        ...
        <field name="F_CITY" source="CITY" minWidowLines="1" spacing="0"
         alignment="start">
          <font face="helvetica" size="10"/>
          <geometryInfo x="4.81250" y="0.00000" width="1.50000"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        <field name="F_REGION_NAME" source="REGION_NAME" minWidowLines="1"
         spacing="0" alignment="start">
          <font face="helvetica" size="10"/>
        ...
        <text name="B_REGION_NAME" minWidowLines="1">
          <textSettings spacing="0"/>
          <geometryInfo x="5.00000" y="0.18750" width="0.93750"
           height="0.18750"/>
          <visualSettings fillBackgroundColor="r25g50b75"/>
          <textSegment>
            <font face="helvetica" size="10" bold="yes"/>
        ...
        <text name="B_CITY" minWidowLines="1">
          <textSettings spacing="0"/>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <reportPrivate defaultReportType="formLike" versionFlags2="0"
   templateName="rwgray"/>
  <reportWebSettings>
  <![CDATA[]]>
  </reportWebSettings>
