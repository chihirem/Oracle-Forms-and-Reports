...
<report name="R9TABULARCHANGE" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="R9TABULARCHANGE" xmlPrologType="text">
    ...
    <dataSource name="Q_1">
      ...
      <group name="G_EMPNO">
        ...
        <dataItem name="EMPNO" oracleDatatype="number" columnOrder="11"
         ...
         columnFlags="32" defaultLabel="Empno" breakOrder="none">
        ...
        <dataItem name="ENAME" datatype="vchar2" columnOrder="12"
         ...
         defaultLabel="Ename" breakOrder="none">
        ...
        <dataItem name="JOB" datatype="vchar2" columnOrder="13" width="9"
         ...
         defaultLabel="Job" breakOrder="none">
        ...
        <dataItem name="MGR" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="60000" defaultHeight="10000"
         columnFlags="32" defaultLabel="Mgr" breakOrder="none">
        ...
        <dataItem name="HIREDATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="32" defaultLabel="Hiredate" breakOrder="none">
        ...
        <dataItem name="SAL" oracleDatatype="number" columnOrder="16"
         ...
         columnFlags="32" defaultLabel="Sal" breakOrder="none">
        ...
        <dataItem name="COMM" oracleDatatype="number" columnOrder="17"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="32" defaultLabel="Comm" breakOrder="none">
        ...
        <dataItem name="DEPTNO" oracleDatatype="number" columnOrder="18"
         ...
         columnFlags="32" defaultLabel="Deptno" breakOrder="none">
        ...
        <repeatingFrame name="R_G_EMPNO" source="G_EMPNO"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_JOB" source="JOB" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="9" textColor="magenta"/>
          ...
          <field name="F_SAL" source="SAL" minWidowLines="1"
           formatMask="LNNNGNNNGNNNGNN0" spacing="0" alignment="end">
            <font face="helvetica" size="9"/>
            <geometryInfo x="4.00000" y="0.18750" width="1.31250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <visualSettings linePattern="solid" lineForegroundColor="darkcyan"/>
          </field>
        ...
        <frame name="M_G_EMPNO_HDR">
          ...
          <text name="B_SAL" minWidowLines="1">
            ...
            <geometryInfo x="4.00000" y="0.00000" width="1.31250"
             height="0.18750"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="darkmagenta" linePattern="solid"
             lineForegroundColor="custom3"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes" textColor="TextColor"
              />
              <string>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="3.55664" y="0.25000" width="1.38672" height="0.16675"
        />
        <textSegment>
          <font face="Courier New" size="10"/>
          <string>
          <![CDATA[EMPLOYEE DETAILS]]>
          </string>
        </textSegment>
      </text>
    </margin>
  ...
  <reportPrivate defaultReportType="tabular" versionFlags2="0"
   templateName="rwbeige" sectionTitle="EMPLOYEE DETAILS"/>
  <reportWebSettings>
  <![CDATA[]]>
  </reportWebSettings>
</report>
