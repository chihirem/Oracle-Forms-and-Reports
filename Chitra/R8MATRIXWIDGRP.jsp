...
<report name="R8MATRIXWIDGRP" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="R8MATRIXWIDGRP" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT DEPTNO,JOB,MGR,SAL FROM EMP]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_MGR">
        <displayInfo x="1.12097" y="1.94995" width="1.75818" height="0.61963"
        />
        <dataItem name="MGR" oracleDatatype="number" columnOrder="13"
