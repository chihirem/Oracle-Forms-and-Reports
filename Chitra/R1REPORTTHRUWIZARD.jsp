...
<report name="R1REPORTTHRUWIZARD" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="R1REPORTTHRUWIZARD" xmlPrologType="text">
...
WHERE (EMPLOYEES.DEPARTMENT_ID = DEPARTMENTS.DEPARTMENT_ID)
      ...
      <group name="G_EMPLOYEE_ID">
        <displayInfo x="1.12097" y="1.94995" width="1.75818" height="1.33936"
        />
...
<rw:dataArea id="MGEMPLOYEEIDGRPFR206">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBEMPLOYEEID206" asArray="no"/> class="OraColumnHeader"> Employee Id </th>
   <th <rw:id id="HBFIRSTNAME206" asArray="no"/> class="OraColumnHeader"> First Name </th>
   <th <rw:id id="HBLASTNAME206" asArray="no"/> class="OraColumnHeader"> Last Name </th>
   <th <rw:id id="HBSALARY206" asArray="no"/> class="OraColumnHeader"> Salary </th>
   <th <rw:id id="HBDEPARTMENTNAME206" asArray="no"/> class="OraColumnHeader"> Department Name </th>
   <th <rw:id id="HBDEPARTMENTID206" asArray="no"/> class="OraColumnHeader"> Department Id </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGEMPLOYEEID2061" src="G_EMPLOYEE_ID">
   <tr>
    <td <rw:headers id="HFEMPLOYEEID206" src="HBEMPLOYEEID206"/> class="OraCellNumber"><rw:field id="FEMPLOYEEID206" src="EMPLOYEE_ID" nullValue="&nbsp;"> F_EMPLOYEE_ID </rw:field></td>
    <td <rw:headers id="HFFIRSTNAME206" src="HBFIRSTNAME206"/> class="OraCellText"><rw:field id="FFIRSTNAME206" src="FIRST_NAME" nullValue="&nbsp;"> F_FIRST_NAME </rw:field></td>
    <td <rw:headers id="HFLASTNAME206" src="HBLASTNAME206"/> class="OraCellText"><rw:field id="FLASTNAME206" src="LAST_NAME" nullValue="&nbsp;"> F_LAST_NAME </rw:field></td>
    <td <rw:headers id="HFSALARY206" src="HBSALARY206"/> class="OraCellNumber"><rw:field id="FSALARY206" src="SALARY" nullValue="&nbsp;"> F_SALARY </rw:field></td>
    <td <rw:headers id="HFDEPARTMENTNAME206" src="HBDEPARTMENTNAME206"/> class="OraCellText"><rw:field id="FDEPARTMENTNAME206" src="DEPARTMENT_NAME" nullValue="&nbsp;"> F_DEPARTMENT_NAME </rw:field></td>
    <td <rw:headers id="HFDEPARTMENTID206" src="HBDEPARTMENTID206"/> class="OraCellNumber"><rw:field id="FDEPARTMENTID206" src="DEPARTMENT_ID" nullValue="&nbsp;"> F_DEPARTMENT_ID </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
