...
<report name="R15MULTIQUERY" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="R15MULTIQUERY" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      ...
      <displayInfo x="1.01038" y="0.62500" width="0.69995" height="0.19995"/>
      <group name="G_EMPNO">
        <displayInfo x="0.77991" y="1.32495" width="1.16089" height="1.62695"
        />
    ...
    <dataSource name="Q_2">
      ...
      <displayInfo x="4.04163" y="0.66663" width="0.69995" height="0.19995"/>
      <group name="G_DEPTNO1">
        <displayInfo x="3.82678" y="1.36658" width="1.12964" height="0.77246"
        />
...
<rw:dataArea id="MGEMPNOGRPFR201">
<table class="OraTable">
<caption>  </caption>
<tr>
 <th <rw:id id="HBEMPNO201" asArray="no"/> class="OraRowHeader"> Empno </th>
 <rw:foreach id="RGEMPNO2011" src="G_EMPNO">
  <td <rw:headers id="HFEMPNO201" src="HBEMPNO201"/> class="OraCellNumber"><rw:field id="FEMPNO201" src="EMPNO" nullValue="&nbsp;"> F_EMPNO </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBENAME201" asArray="no"/> class="OraRowHeader"> Ename </th>
 <rw:foreach id="RGEMPNO2012" src="G_EMPNO">
  <td <rw:headers id="HFENAME201" src="HBENAME201"/> class="OraCellText"><rw:field id="FENAME201" src="ENAME" nullValue="&nbsp;"> F_ENAME </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBJOB201" asArray="no"/> class="OraRowHeader"> Job </th>
 <rw:foreach id="RGEMPNO2013" src="G_EMPNO">
  <td <rw:headers id="HFJOB201" src="HBJOB201"/> class="OraCellText"><rw:field id="FJOB201" src="JOB" nullValue="&nbsp;"> F_JOB </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBMGR201" asArray="no"/> class="OraRowHeader"> Mgr </th>
 <rw:foreach id="RGEMPNO2014" src="G_EMPNO">
  <td <rw:headers id="HFMGR201" src="HBMGR201"/> class="OraCellNumber"><rw:field id="FMGR201" src="MGR" nullValue="&nbsp;"> F_MGR </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBHIREDATE201" asArray="no"/> class="OraRowHeader"> Hiredate </th>
 <rw:foreach id="RGEMPNO2015" src="G_EMPNO">
  <td <rw:headers id="HFHIREDATE201" src="HBHIREDATE201"/> class="OraCellText"><rw:field id="FHIREDATE201" src="HIREDATE" nullValue="&nbsp;"> F_HIREDATE </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBSAL201" asArray="no"/> class="OraRowHeader"> Sal </th>
 <rw:foreach id="RGEMPNO2016" src="G_EMPNO">
  <td <rw:headers id="HFSAL201" src="HBSAL201"/> class="OraCellNumber"><rw:field id="FSAL201" src="SAL" nullValue="&nbsp;"> F_SAL </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBCOMM201" asArray="no"/> class="OraRowHeader"> Comm </th>
 <rw:foreach id="RGEMPNO2017" src="G_EMPNO">
  <td <rw:headers id="HFCOMM201" src="HBCOMM201"/> class="OraCellNumber"><rw:field id="FCOMM201" src="COMM" nullValue="&nbsp;"> F_COMM </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBDEPTNO201" asArray="no"/> class="OraRowHeader"> Deptno </th>
 <rw:foreach id="RGEMPNO2018" src="G_EMPNO">
  <td <rw:headers id="HFDEPTNO201" src="HBDEPTNO201"/> class="OraCellNumber"><rw:field id="FDEPTNO201" src="DEPTNO" nullValue="&nbsp;"> F_DEPTNO </rw:field></td>
 </rw:foreach>
</tr>
</table>
</rw:dataArea> <!-- id="MGEMPNOGRPFR201" -->
...
<!-- Data Area Generated by Reports Developer -->
<rw:dataArea id="MGDEPTNO1GRPFR201">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBDEPTNO1201" asArray="no"/> class="OraColumnHeader"> Deptno1 </th>
   <th <rw:id id="HBDNAME201" asArray="no"/> class="OraColumnHeader"> Dname </th>
   <th <rw:id id="HBLOC201" asArray="no"/> class="OraColumnHeader"> Loc </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGDEPTNO12011" src="G_DEPTNO1">
   <tr>
    <td <rw:headers id="HFDEPTNO1201" src="HBDEPTNO1201"/> class="OraCellNumber"><rw:field id="FDEPTNO1201" src="DEPTNO1" nullValue="&nbsp;"> F_DEPTNO1 </rw:field></td>
    <td <rw:headers id="HFDNAME201" src="HBDNAME201"/> class="OraCellText"><rw:field id="FDNAME201" src="DNAME" nullValue="&nbsp;"> F_DNAME </rw:field></td>
    <td <rw:headers id="HFLOC201" src="HBLOC201"/> class="OraCellText"><rw:field id="FLOC201" src="LOC" nullValue="&nbsp;"> F_LOC </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
