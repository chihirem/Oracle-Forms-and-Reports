...
<report name="R15_Multi_Query" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="R15_MULTI_QUERY" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      ...
      <displayInfo x="1.26038" y="0.58337" width="0.69995" height="0.19995"/>
      <group name="G_EMPNO">
        <displayInfo x="1.02991" y="1.28333" width="1.16089" height="1.62695"
        />
    ...
    <dataSource name="Q_2">
      ...
      <displayInfo x="3.26038" y="0.55212" width="0.69995" height="0.19995"/>
      <group name="G_DEPTNO1">
        <displayInfo x="3.04553" y="1.25208" width="1.12964" height="0.77246"
        />
  ...
  <section name="main">
    <body>
      <frame name="M_G_EMPNO_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="2.12500" height="1.50000"
        />
         ...
         printDirection="acrossDown" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_EMPNO" source="EMPNO" minWidowLines="1" spacing="0"
           alignment="start">
            ...
            <geometryInfo x="0.62500" y="0.00000" width="0.93750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          ...
          <field name="F_MGR" source="MGR" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="9"/>
            <geometryInfo x="0.62500" y="0.56250" width="0.93750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          ...
          <field name="F_COMM" source="COMM" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="9"/>
            <geometryInfo x="0.62500" y="1.12500" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_DEPTNO" source="DEPTNO" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="9"/>
            <geometryInfo x="0.62500" y="1.31250" width="0.62500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_EMPNO_HDR">
          ...
          <text name="B_COMM" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.00000" y="1.12500" width="0.62500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes" textColor="TextColor"
          ...
          <text name="B_DEPTNO" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.00000" y="1.31250" width="0.62500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes" textColor="TextColor"
      ...
      <frame name="M_G_DEPTNO1_GRPFR">
        <geometryInfo x="0.00000" y="1.50000" width="3.62500" height="0.37500"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_DEPTNO1" source="G_DEPTNO1"
         printDirection="down" minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="1.68750" width="3.62500"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="TableCell"/>
          <field name="F_DEPTNO1" source="DEPTNO1" minWidowLines="1"
           spacing="0" alignment="start">
            ...
            <geometryInfo x="0.00000" y="1.68750" width="0.62500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_DNAME" source="DNAME" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="0.62500" y="1.68750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_LOC" source="LOC" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="2.12500" y="1.68750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_DEPTNO1_HDR">
          <geometryInfo x="0.00000" y="1.50000" width="3.62500"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="allPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
          ...
          <text name="B_DEPTNO1" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.00000" y="1.50000" width="0.62500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
          ...
          <text name="B_DNAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.62500" y="1.50000" width="1.50000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_LOC" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.12500" y="1.50000" width="1.50000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
<rw:dataArea id="MGEMPNOGRPFR103">
<table class="OraTable">
<caption>  </caption>
<tr>
 <th <rw:id id="HBEMPNO103" asArray="no"/> class="OraRowHeader"> Empno </th>
 <rw:foreach id="RGEMPNO1031" src="G_EMPNO">
  <td <rw:headers id="HFEMPNO103" src="HBEMPNO103"/> class="OraCellNumber"><rw:field id="FEMPNO103" src="EMPNO" nullValue="&nbsp;"> F_EMPNO </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBENAME103" asArray="no"/> class="OraRowHeader"> Ename </th>
 <rw:foreach id="RGEMPNO1032" src="G_EMPNO">
  <td <rw:headers id="HFENAME103" src="HBENAME103"/> class="OraCellText"><rw:field id="FENAME103" src="ENAME" nullValue="&nbsp;"> F_ENAME </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBJOB103" asArray="no"/> class="OraRowHeader"> Job </th>
 <rw:foreach id="RGEMPNO1033" src="G_EMPNO">
  <td <rw:headers id="HFJOB103" src="HBJOB103"/> class="OraCellText"><rw:field id="FJOB103" src="JOB" nullValue="&nbsp;"> F_JOB </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBMGR103" asArray="no"/> class="OraRowHeader"> Mgr </th>
 <rw:foreach id="RGEMPNO1034" src="G_EMPNO">
  <td <rw:headers id="HFMGR103" src="HBMGR103"/> class="OraCellNumber"><rw:field id="FMGR103" src="MGR" nullValue="&nbsp;"> F_MGR </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBHIREDATE103" asArray="no"/> class="OraRowHeader"> Hiredate </th>
 <rw:foreach id="RGEMPNO1035" src="G_EMPNO">
  <td <rw:headers id="HFHIREDATE103" src="HBHIREDATE103"/> class="OraCellText"><rw:field id="FHIREDATE103" src="HIREDATE" nullValue="&nbsp;"> F_HIREDATE </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBSAL103" asArray="no"/> class="OraRowHeader"> Sal </th>
 <rw:foreach id="RGEMPNO1036" src="G_EMPNO">
  <td <rw:headers id="HFSAL103" src="HBSAL103"/> class="OraCellNumber"><rw:field id="FSAL103" src="SAL" nullValue="&nbsp;"> F_SAL </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBCOMM103" asArray="no"/> class="OraRowHeader"> Comm </th>
 <rw:foreach id="RGEMPNO1037" src="G_EMPNO">
  <td <rw:headers id="HFCOMM103" src="HBCOMM103"/> class="OraCellNumber"><rw:field id="FCOMM103" src="COMM" nullValue="&nbsp;"> F_COMM </rw:field></td>
 </rw:foreach>
</tr>
<tr>
 <th <rw:id id="HBDEPTNO103" asArray="no"/> class="OraRowHeader"> Deptno </th>
 <rw:foreach id="RGEMPNO1038" src="G_EMPNO">
  <td <rw:headers id="HFDEPTNO103" src="HBDEPTNO103"/> class="OraCellNumber"><rw:field id="FDEPTNO103" src="DEPTNO" nullValue="&nbsp;"> F_DEPTNO </rw:field></td>
 </rw:foreach>
</tr>
</table>
</rw:dataArea> <!-- id="MGEMPNOGRPFR103" -->
...
<!-- Data Area Generated by Reports Developer -->
<rw:dataArea id="MGDEPTNO1GRPFR103">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBDEPTNO1103" asArray="no"/> class="OraColumnHeader"> Deptno1 </th>
   <th <rw:id id="HBDNAME103" asArray="no"/> class="OraColumnHeader"> Dname </th>
   <th <rw:id id="HBLOC103" asArray="no"/> class="OraColumnHeader"> Loc </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGDEPTNO11031" src="G_DEPTNO1">
   <tr>
    <td <rw:headers id="HFDEPTNO1103" src="HBDEPTNO1103"/> class="OraCellNumber"><rw:field id="FDEPTNO1103" src="DEPTNO1" nullValue="&nbsp;"> F_DEPTNO1 </rw:field></td>
    <td <rw:headers id="HFDNAME103" src="HBDNAME103"/> class="OraCellText"><rw:field id="FDNAME103" src="DNAME" nullValue="&nbsp;"> F_DNAME </rw:field></td>
    <td <rw:headers id="HFLOC103" src="HBLOC103"/> class="OraCellText"><rw:field id="FLOC103" src="LOC" nullValue="&nbsp;"> F_LOC </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
