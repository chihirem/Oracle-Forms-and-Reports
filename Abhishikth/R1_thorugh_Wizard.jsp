...
<report name="R1_thorugh_Wizard" DTDVersion="9.0.2.0.10">
...
<rw:dataArea id="MGEMPLOYEEIDGRPFR87">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBEMPLOYEEID87" asArray="no"/> class="OraColumnHeader"> Employee Id </th>
   <th <rw:id id="HBFIRSTNAME87" asArray="no"/> class="OraColumnHeader"> First Name </th>
   <th <rw:id id="HBLASTNAME87" asArray="no"/> class="OraColumnHeader"> Last Name </th>
   <th <rw:id id="HBSALARY87" asArray="no"/> class="OraColumnHeader"> Salary </th>
   <th <rw:id id="HBDEPARTMENTNAME87" asArray="no"/> class="OraColumnHeader"> Department Name </th>
   <th <rw:id id="HBDEPARTMENTID87" asArray="no"/> class="OraColumnHeader"> Department Id </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGEMPLOYEEID871" src="G_EMPLOYEE_ID">
   <tr>
    <td <rw:headers id="HFEMPLOYEEID87" src="HBEMPLOYEEID87"/> class="OraCellNumber"><rw:field id="FEMPLOYEEID87" src="EMPLOYEE_ID" nullValue="&nbsp;"> F_EMPLOYEE_ID </rw:field></td>
    <td <rw:headers id="HFFIRSTNAME87" src="HBFIRSTNAME87"/> class="OraCellText"><rw:field id="FFIRSTNAME87" src="FIRST_NAME" nullValue="&nbsp;"> F_FIRST_NAME </rw:field></td>
    <td <rw:headers id="HFLASTNAME87" src="HBLASTNAME87"/> class="OraCellText"><rw:field id="FLASTNAME87" src="LAST_NAME" nullValue="&nbsp;"> F_LAST_NAME </rw:field></td>
    <td <rw:headers id="HFSALARY87" src="HBSALARY87"/> class="OraCellNumber"><rw:field id="FSALARY87" src="SALARY" nullValue="&nbsp;"> F_SALARY </rw:field></td>
    <td <rw:headers id="HFDEPARTMENTNAME87" src="HBDEPARTMENTNAME87"/> class="OraCellText"><rw:field id="FDEPARTMENTNAME87" src="DEPARTMENT_NAME" nullValue="&nbsp;"> F_DEPARTMENT_NAME </rw:field></td>
    <td <rw:headers id="HFDEPARTMENTID87" src="HBDEPARTMENTID87"/> class="OraCellNumber"><rw:field id="FDEPARTMENTID87" src="DEPARTMENT_ID" nullValue="&nbsp;"> F_DEPARTMENT_ID </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
