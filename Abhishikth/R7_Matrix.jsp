...
<report name="R7_Matrix" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[select job,sal,deptno from emp]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_job">
        <displayInfo x="1.45007" y="1.94995" width="1.09998" height="0.43970"
        />
        <dataItem name="job" datatype="vchar2" columnOrder="11" width="9"
      ...
      <group name="G_deptno">
        ...
        />
        <dataItem name="deptno" oracleDatatype="number" columnOrder="13"
      ...
      <group name="G_sal">
        ...
        />
        <dataItem name="sal" oracleDatatype="number" columnOrder="12"
         ...
         defaultLabel="Sal" breakOrder="none">
          <dataDescriptor expression="sal" descriptiveExpression="SAL"
           order="2" width="22" scale="2" precision="7"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="3.68665" y="0.25000" width="1.12671" height="0.16675"
        />
        <textSegment>
  ...
  <reportPrivate defaultReportType="matrix" versionFlags2="0"
   templateName="rwbeige" sectionTitle="Matrix Report"/>
  <reportWebSettings>
  <![CDATA[]]>
  </reportWebSettings>
</report>
