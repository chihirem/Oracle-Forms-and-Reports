...
<report name="R2_reentrant" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="R2_REENTRANT" xmlPrologType="text">
...
<rw:dataArea id="MGEMPLOYEEIDGRPFR11">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBEMPLOYEEID11" asArray="no"/> class="OraColumnHeader"> Employee Id </th>
   <th <rw:id id="HBFIRSTNAME11" asArray="no"/> class="OraColumnHeader"> First Name </th>
   <th <rw:id id="HBLASTNAME11" asArray="no"/> class="OraColumnHeader"> Last Name </th>
   <th <rw:id id="HBSALARY11" asArray="no"/> class="OraColumnHeader"> Salary </th>
   <th <rw:id id="HBDEPARTMENTNAME11" asArray="no"/> class="OraColumnHeader"> Department Name </th>
   <th <rw:id id="HBDEPARTMENTID11" asArray="no"/> class="OraColumnHeader"> Department Id </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGEMPLOYEEID111" src="G_EMPLOYEE_ID">
   <tr>
    <td <rw:headers id="HFEMPLOYEEID11" src="HBEMPLOYEEID11"/> class="OraCellNumber"><rw:field id="FEMPLOYEEID11" src="EMPLOYEE_ID" nullValue="&nbsp;"> F_EMPLOYEE_ID </rw:field></td>
    <td <rw:headers id="HFFIRSTNAME11" src="HBFIRSTNAME11"/> class="OraCellText"><rw:field id="FFIRSTNAME11" src="FIRST_NAME" nullValue="&nbsp;"> F_FIRST_NAME </rw:field></td>
    <td <rw:headers id="HFLASTNAME11" src="HBLASTNAME11"/> class="OraCellText"><rw:field id="FLASTNAME11" src="LAST_NAME" nullValue="&nbsp;"> F_LAST_NAME </rw:field></td>
    <td <rw:headers id="HFSALARY11" src="HBSALARY11"/> class="OraCellNumber"><rw:field id="FSALARY11" src="SALARY" nullValue="&nbsp;"> F_SALARY </rw:field></td>
    <td <rw:headers id="HFDEPARTMENTNAME11" src="HBDEPARTMENTNAME11"/> class="OraCellText"><rw:field id="FDEPARTMENTNAME11" src="DEPARTMENT_NAME" nullValue="&nbsp;"> F_DEPARTMENT_NAME </rw:field></td>
    <td <rw:headers id="HFDEPARTMENTID11" src="HBDEPARTMENTID11"/> class="OraCellNumber"><rw:field id="FDEPARTMENTID11" src="DEPARTMENT_ID" nullValue="&nbsp;"> F_DEPARTMENT_ID </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFSumSALARYPerReport11" src="HBSALARY11"/> class="OraTotalNumber">Total: <rw:field id="FSumSALARYPerReport11" src="SumSALARYPerReport" nullValue="&nbsp;"> F_SumSALARYPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
 </tr>
</table>
