...
<report name="R5_Form_Letter" DTDVersion="9.0.2.0.10">
       ...
       columnMode="no">
        ...
        <text name="B_tbp" minWidowLines="1">
          ...
          <textSegment>
            <font face="helvetica" size="10" bold="yes"/>
            <string>
            <![CDATA[This is to bring to your kind notice that your salary of Rs.&<SALARY>  will be incremented by 10 percent considering your performance in PL/SQL.
]]>
            </string>
          </textSegment>
          <textSegment>
